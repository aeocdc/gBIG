...
#sgrna
def sgrnacas9(taskSpacePath,geneFilePath,referenceFilePath,sgrnaAppFilePath,nxmAppFilePath):
    #backup 
    #import uuid
    ...
    time7=str(time2-time1)
    time8=str(time3-time2)
    time9=str(time4-time3)
    time10=str(time5-time4)
    time11=str(time6-time5)
    time12=str(time6-time1)
    time13=time7+'|'+time8+'|'+time9+'|'+time10+'|'+time11+'|'+time12
    timeall=time13.split()
