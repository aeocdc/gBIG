        ...
        if form.is_valid():# 如果提交的数据合法
            ...
            if queryName=="sgrna5Design":
                ...
                if base_editor_value=='Target_AID1':
                    ...
                    nxmAppFilePath="/home/webservice/bioeledbtib/componenttib/func/check_sgRNA_C_4-10-20181127_BE.pl"
                #
                ...
                sgrna_reportFilePath=sgrnacas9(taskSpacePath,geneFilePath,referenceFilePath,sgrnaAppFilePath,nxmAppFilePath)
                time3=time.time()
                #session
                ...
                time4=time.time()
                time5=str(time2-time1)
                time6=str(time3-time2)
                time7=str(time4-time3)
                time8=str(time4-time1)
                #email
                wetlab_email='mao_zt@tib.cas.cn'
                subject="SgRNA"
                content="SgRNA\n"
